...
typedef struct universal_mob_ai {
    ...
    /* MEMORY */
    int num_memories;
    struct mob_memory *memories[50];  /* Last 50 memories */

    /* RELATIONSHIPS */
    int num_relationships;
    struct mob_relationship *relationships[20];

    /* GOALS & MOTIVATIONS */
    int num_goals;
    struct mob_goal *goals[5];   /* Up to 5 active goals */
...
static inline void example_intelligent_farmer(void)
{
    /*
     * FARMER TOM
...
static inline void example_merchant_expansion(void)
{
    /*
     * MERCHANT GRETA
...
static inline void example_guard_creates_militia(void)
{
    /*
...
static inline void example_archmage_creates_school(void)
{
    /*
     * ARCHMAGE ELDRIN
...
static inline void example_wolf_pack_intelligence(void)
{
    /*
     * ALPHA WOLF
