...
{
    static char benevolent_str[] = "Benevolent";
    static char neutral_str[] = "Neutral";
    static char stern_str[] = "Stern";
    static char wrathful_str[] = "Wrathful";
    static char playful_str[] = "Playful";
    static char unknown_str[] = "Unknown";

    switch (mood)
    {
        case BEELER_MOOD_BENEVOLENT: return benevolent_str;
        case BEELER_MOOD_NEUTRAL:    return neutral_str;
        case BEELER_MOOD_STERN:      return stern_str;
        case BEELER_MOOD_WRATHFUL:   return wrathful_str;
        case BEELER_MOOD_PLAYFUL:    return playful_str;
...
void do_snapshot(CHAR_DATA *ch, char *argument)
{
    ...
    if (!str_cmp(arg1, "create"))
    {
        ...
        snapshot = create_snapshot(arg2, argument, (char *)ch->name);
        if (snapshot)
        {
