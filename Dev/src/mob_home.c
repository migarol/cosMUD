...
{
    static char hovel_str[] = "Hovel";
    static char apartment_str[] = "Apartment";
    static char house_str[] = "House";
    static char manor_str[] = "Manor";
    static char palace_str[] = "Palace";
    static char inn_room_str[] = "Inn Room";
    static char barracks_str[] = "Barracks";
    static char dormitory_str[] = "Dormitory";
    static char unknown_str[] = "Unknown";

    switch (home_type)
    {
        case HOME_TYPE_HOVEL:      return hovel_str;
        case HOME_TYPE_APARTMENT:  return apartment_str;
        case HOME_TYPE_HOUSE:      return house_str;
        case HOME_TYPE_MANOR:      return manor_str;
        case HOME_TYPE_PALACE:     return palace_str;
        case HOME_TYPE_INN_ROOM:   return inn_room_str;
        case HOME_TYPE_BARRACKS:   return barracks_str;
        case HOME_TYPE_DORMITORY:  return dormitory_str;
