...
DECLARE_DO_FUN( do_beeler_build     );
DECLARE_DO_FUN( do_beeler_context   );
DECLARE_DO_FUN( do_beeler_populate  );
DECLARE_DO_FUN( do_beeler_stats     );
DECLARE_DO_FUN( do_beelercommand    );
DECLARE_DO_FUN( do_beelerplan       );
...
DECLARE_DO_FUN( do_genpersonality );
...
DECLARE_DO_FUN( do_homeassign   );
DECLARE_DO_FUN( do_homeinfo     );
DECLARE_DO_FUN( do_homeslist    );
DECLARE_DO_FUN( do_homeunassign );
...
DECLARE_DO_FUN( do_innlist      );
DECLARE_DO_FUN( do_innrent      );
...
DECLARE_DO_FUN( do_mobidentity  );
DECLARE_DO_FUN( do_mobmemory    );
